using Assets.Scripts.Enemy.DeathBringer;
using UnityEngine;
...
public class Enemy_DeathBringer : Enemy
{
    ...
    public void FindPosition()
    {
        ...
        while (attempts < maxAttempts)
        {
            ...
            float groundDistance = GroundBelow().distance;
            transform.position = new Vector3(transform.position.x, transform.position.y - groundDistance + (cd.size.y / 2));
