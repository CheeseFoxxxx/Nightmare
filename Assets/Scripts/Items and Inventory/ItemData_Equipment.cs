...
public class ItemData_Equipment : ItemData
{
    ...
    public void AddModifiers()
    {
        ...
        playerStats.intelligence.AddModifier(intelligency);
    ...
    public void RemoveModifiers()
    {
        ...
        playerStats.intelligence.RemoveModifier(intelligency);
    ...
    public override string GetDescription()
    {
        ...
        AddItemDescription(intelligency, "intelligence");
