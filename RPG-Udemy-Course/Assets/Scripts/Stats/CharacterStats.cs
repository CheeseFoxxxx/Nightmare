...
public class CharacterStats : MonoBehaviour
{
    ...
    [Header("Major stats")]
    public Stats strength;//力量  伤害/爆伤
    public Stats agility;//敏捷  闪避/暴击率
    public Stats intelligence;//智力  法伤/法抗
    public Stats vitality;//活力  生命
    ...
    public bool isChilled;//减20%护甲
    public bool isShocked;//减少攻击命中率
    ...
    private void AttemptToApplyAilements(CharacterStats _targetStats, int _fireDamage, int _iceDamage, int _lightningDamage)
    {
        ...
        while (!canApplyIgnite && !canApplyChill && !canApplyShock)
        {
            ...
            if (Random.value < 1 && _lightningDamage > 0)
            {
                canApplyShock = true;
                _targetStats.ApplyAilments(canApplyIgnite, canApplyChill, canApplyShock);
