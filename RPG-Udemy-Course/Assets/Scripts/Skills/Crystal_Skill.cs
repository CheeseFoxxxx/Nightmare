...
public class Crystal_Skill : Skill
{
    ...
    [SerializeField] private bool cloneInsteadOfCeystal;
    ...
    public override void UseSkill()
    {
        ...
        else
        {
            ...
            {
                currentCrystal.GetComponent<Crystal_Skill_Contrller>()?.FinishCrystal();
            }
    ...
    public void CreateCrystal()
    {
        ...
        Crystal_Skill_Contrller currentCrystalScript = currentCrystal.GetComponent<Crystal_Skill_Contrller>();
    ...
    public void CurrentCrystalChooseRandomTarget() => currentCrystal.GetComponent<Crystal_Skill_Contrller>().ChooseRandomEnemy();
    ...
    private bool CanUseMultiCrystal()
    {
        if(canUseMultiStacks)
        {
            if(crystalleft.Count > 0)
            {
                ...
                newCrystal.GetComponent <Crystal_Skill_Contrller>().
